...
export function SimulationResults({ simulation }: SimulationResultsProps) {
  if (!simulation) {
    return (
      <div className="p-6 text-center bg-gray-50 dark:bg-gray-900 rounded-lg">
        <p className="text-gray-500 dark:text-gray-400">Select a simulation to view results</p>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 text-center">
        <div className="inline-block p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-yellow-800 dark:text-yellow-200 font-medium">⏳ Simulation Pending</p>
    ...
    return (
      <div className="p-6 text-center">
        <div className="inline-block p-6 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-blue-800 dark:text-blue-200 font-medium mb-3">▶️ Simulation Running</p>
    ...
    return (
      <div className="p-6">
        <div className="p-6 bg-red-50 border border-red-200 rounded-lg">
          <p className="text-red-800 dark:text-red-200 font-medium">❌ Simulation Failed</p>
  ...
  if (simulation.status === 'cancelled') {
    return (
      <div className="p-6">
        <div className="p-6 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
          <p className="text-gray-800 dark:text-gray-100 font-medium">🚫 Simulation Cancelled</p>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">This simulation was cancelled before completion.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 space-y-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th className="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-300">Card</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-700 dark:text-gray-300">Seen %</th>
                </tr>
              </thead>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th className="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-300">Mulligans</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-700 dark:text-gray-300">Games</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-700 dark:text-gray-300">Percentage</th>
                </tr>
              </thead>
              <tbody className="divide-y">
      ...
      {cardStats.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Top cards by seen percentage</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th className="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-300">Card</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-700 dark:text-gray-300">Seen %</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-700 dark:text-gray-300">Cast %</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                {cardStats
      ...
      {graveyardStats.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Average cards in graveyard</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th className="px-4 py-3 text-left font-medium text-gray-700 dark:text-gray-300">Card</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-700 dark:text-gray-300">Avg Count</th>
